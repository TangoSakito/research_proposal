...
\author{Sakito Tango\thanks{id: 29246024, 
        % email: \texttt{tango-sakito@g.ecc.u-tokyo.ac.jp}
...
% \begin{enumerate}
%   \item Do mothers work more if coetaneous children decrease and the childcare service becomes easier to access? \label{rq1}
%   \item Do married couples avoid having children if they expect coetaneous children increase and the childcare service becomes harder to access? \label{rq2}
% \end{enumerate}
...
%   \url{https://www3.nhk.or.jp/news/html/20240501/k10014437371000.html}.
% }.
...
% Also, if some couples postpone the birth of children, many other couples expect the increase in birth in following years and
% \todo{add explanation}
...
% I separate mothers into groups depending on their first child's birth date. 
